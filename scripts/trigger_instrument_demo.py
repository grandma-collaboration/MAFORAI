...
from skyportal_corpus.extraction_v2.trigger_instrument import TriggerInstrumentExtractor  # noqa: E402
...
def main() -> int:
    extractor = TriggerInstrumentExtractor()
    ...
    if chosen is None:
        if first is None:
            ...
            return 1
        print("No se hallo trigger instrument en los primeros 50 circulars; usando el primero.")
        chosen = first

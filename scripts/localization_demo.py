...
from skyportal_corpus.extraction_v2.localization import LocalizationExtractor  # noqa: E402
...
def main() -> int:
    extractor = LocalizationExtractor()
    ...
    if annotations:
        for annotation in annotations:
            print(
                ...
                f"certainty={annotation.certainty} value={annotation.value} unit={annotation.unit!r} "
    ...
    print("checks:")
    for annotation in annotations:
        print(f"  {annotation.rule_id} {annotation.span_start}-{annotation.span_end}: {_status(annotation.verify(doc.rendered_text))}")
